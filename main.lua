...
function love.draw()
    ...
    love.graphics.draw(Game.sprites, Game.bird.frames[Game.activeFrame], love.graphics.getWidth() / 2, love.graphics.getHeight() / 3, 0, 0.7, 0.7, ({Game.bird.frames[Game.activeFrame]:getViewport()})[3] / 2, ({Game.bird.frames[Game.activeFrame]:getViewport()})[4] / 2)
end
